  ...
  return (
    <>
      <div className="bg-white shadow-[1px_1px_1px_rgba(0,0,0,0.2)] w-full text-center">
        <button className="py-3 px-4 text-[#2790B0] text-sm">Trang chủ </button>
        <button className="py-3 px-4 text-[#2790B0] text-sm">
          List truyện
        </button>
        <button className="py-3 px-4 text-[#2790B0] text-sm">List phim</button>
        <button className="py-3 px-4 text-[#2790B0] text-sm">
      ...
      <div className="w-full text-center text-8xl text-[#731C81] font-medium italic mb-[65px]">
